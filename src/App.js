...
class App extends React.Component {
  ...
  fetchTasks(){
    ...
    fetch('http://18.219.241.55:8000/api/task-list/')
  ...
  deleteItem(task){
    ...
    fetch(`http://18.219.241.55:8000/api/task-delete/${task.id}/`, {
      method:'DELETE',
      headers:{
        'Content-type':'application/json',
        'X-CSRFToken':csrftoken,
  ...
  strikeUnstrike(task){
    ...
    var csrftoken = this.getCookie('csrftoken')
    var url = `http://18.219.241.55:8000/api/task-update/${task.id}/`
